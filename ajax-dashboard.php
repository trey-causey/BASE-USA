...
<?php if($fcstorg == 'DarkSky') { ?>
     <tr><td>&nbsp;</td><td>
		 <?php $dsCredit = langtransstr('Forecast').' '.langtransstr('Powered by Dark Sky'); ?>
<br/><a href="https://darksky.net/poweredby/" title="<?php echo $dsCredit; ?>"><?php echo $dsCredit; ?></a>
     </td></tr>
<?php } ?>
       </table>
	 </td>
